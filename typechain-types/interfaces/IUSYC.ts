...
export interface IUSYCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IUSYC extends BaseContract {
  connect(runner?: ContractRunner | null): IUSYC;
  waitForDeployment(): Promise<this>;

  interface: IUSYCInterface;
